        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center space-y-2">
            <p className="text-sm text-gray-600">
              ...
              <span className="font-mono text-xs bg-gray-100 px-2 py-1 rounded">Email: jageshwarsahu910@gmail.com</span><br/>
              <span className="font-mono text-xs bg-gray-100 px-2 py-1 rounded">Password: Jaggu@29</span>
            </p>
            <div className="pt-2">
              <a href="/admin" className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md">
